...
WebUI.click(findTestObject('Page_Free Online Appointment Scheduling Sof_f04a6a/button_Cookie Settings_onetrust-close-btn-h_80df1f'))
...
WebUI.setEncryptedText(findTestObject('Page_Log in - Calendly/input_Enter your password_password'), '1WYlni7sVJ8tWhJ/yk+Lvg==')
